...
func (x *WatchInstruction) Reset() {
	*x = WatchInstruction{}
	mi := &file_rpc_orchard_proto_msgTypes[0]
...
func (*WatchInstruction) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0}
}
...
func (x *PortForwardData) Reset() {
	*x = PortForwardData{}
	mi := &file_rpc_orchard_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PortForwardData) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExecData) Reset() {
	*x = ExecData{}
	mi := &file_rpc_orchard_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecData) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{2}
}
...
func (x *ResolveIPResult) Reset() {
	*x = ResolveIPResult{}
	mi := &file_rpc_orchard_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveIPResult) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{3}
}
...
func (x *WatchInstruction_PortForward) Reset() {
	*x = WatchInstruction_PortForward{}
	mi := &file_rpc_orchard_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchInstruction_PortForward) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *WatchInstruction_SyncVMs) Reset() {
	*x = WatchInstruction_SyncVMs{}
	mi := &file_rpc_orchard_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchInstruction_SyncVMs) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *WatchInstruction_ResolveIP) Reset() {
	*x = WatchInstruction_ResolveIP{}
	mi := &file_rpc_orchard_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchInstruction_ResolveIP) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *WatchInstruction_Exec) Reset() {
	*x = WatchInstruction_Exec{}
	mi := &file_rpc_orchard_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchInstruction_Exec) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *WatchInstruction_Exec_TerminalSize) Reset() {
	*x = WatchInstruction_Exec_TerminalSize{}
	mi := &file_rpc_orchard_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchInstruction_Exec_TerminalSize) Descriptor() ([]byte, []int) {
	return file_rpc_orchard_proto_rawDescGZIP(), []int{0, 3, 0}
}
...
var File_rpc_orchard_proto protoreflect.FileDescriptor

const file_rpc_orchard_proto_rawDesc = "" +
	"\n" +
	"\x11rpc/orchard.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xf3\x05\n" +
...
var (
	file_rpc_orchard_proto_rawDescOnce sync.Once
	file_rpc_orchard_proto_rawDescData []byte
)

func file_rpc_orchard_proto_rawDescGZIP() []byte {
	file_rpc_orchard_proto_rawDescOnce.Do(func() {
		file_rpc_orchard_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_rpc_orchard_proto_rawDesc), len(file_rpc_orchard_proto_rawDesc)))
	})
	return file_rpc_orchard_proto_rawDescData
}

var file_rpc_orchard_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_rpc_orchard_proto_goTypes = []any{
...
var file_rpc_orchard_proto_depIdxs = []int32{
...
func init() { file_rpc_orchard_proto_init() }
func file_rpc_orchard_proto_init() {
	if File_rpc_orchard_proto != nil {
		return
	}
	file_rpc_orchard_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_rpc_orchard_proto_rawDesc), len(file_rpc_orchard_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_rpc_orchard_proto_goTypes,
		DependencyIndexes: file_rpc_orchard_proto_depIdxs,
		MessageInfos:      file_rpc_orchard_proto_msgTypes,
	}.Build()
	File_rpc_orchard_proto = out.File
	file_rpc_orchard_proto_goTypes = nil
	file_rpc_orchard_proto_depIdxs = nil
}
